...
local themes = {
    guda = {
        ...
        nineSlice = {
            corner = "Interface\\AddOns\\GudaBags\\Assets\\NineSlice-Corner",
            edgeH  = "Interface\\AddOns\\GudaBags\\Assets\\NineSlice-EdgeH",
            edgeV  = "Interface\\AddOns\\GudaBags\\Assets\\NineSlice-EdgeV",
            cornerSize = 32,
            edgeThickness = 16,
        },
    ...
    blizzard = {
        ...
        bgTile = true,
        bgTileSize = 16,
        bgOverlay = "Interface\\AddOns\\GudaBags\\Assets\\UI-Background-Rock",
        border = {
            edgeFile = "Interface\\DialogFrame\\UI-DialogBox-Border",
            edgeSize = 32,
            insets = { left = 11, right = 12, top = 12, bottom = 11 }
